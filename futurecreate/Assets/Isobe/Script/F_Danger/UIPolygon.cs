...
public class UIPolygon : MaskableGraphic
{
    ...
    [SerializeField, Range(0f, 1.0f)] private float AllDistance = 0.5f;
    [SerializeField, Range(0f, 1f)] private float[] verticesDistance = new float[] { };
    [SerializeField, Range(0f, 1.0f)] private float filledInit = 0.2f;
    ...
    public void SetDistance(float values,int num)
    {
        verticesDistance[num] = values;
    ...
    private void InitUserData()
    {
        if (verticesDistance.Length != sides)
        {
            ...
            {
                verticesDistance[i] = AllDistance;
            }
            filled = filledInit;
        }
    }
